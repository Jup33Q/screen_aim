...
#ifndef AIMPHONE_SWIFT_H
#define AIMPHONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AimPhone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8AimPhone14CameraStreamer")
@interface CameraStreamer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface CameraStreamer (SWIFT_EXTENSION(AimPhone)) <AVCaptureVideoDataOutputSampleBufferDelegate>
